...
public:
    ReadbackItem(unsigned int index, bool enable,
                 ...
                 EMMC_Part_E region_id = EMMC_PART_USER,
    ...
    explicit ReadbackItem(RB_INFO &rb_info, NUTL_AddrTypeFlag_E addr_flag):
        ...
        region_id_((EMMC_Part_E)rb_info.part_id), addr_flag_(addr_flag)
    {}
    ...
    EMMC_Part_E region() const { return region_id_;}
