...
{
public:
    CRestoreWorker(U64 addr, U64 leng, U64 dest, NUTL_ReadFlag_E flag, unsigned short part);
...
{
public:
    CDefaultRestoreWorker(U64 addr, U64 leng, U64 dest, NUTL_ReadFlag_E flag, unsigned short part);
...
{
public:
    CNvRamRestoreWorker(U64 addr, U64 leng, U64 dest, NUTL_ReadFlag_E flag, unsigned short part);
