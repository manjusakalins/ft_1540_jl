...
/* SV5 ANDROID } */
    ...
    //beging of status_ex, for new arch lib & DA, begin from 0x8001
	,STATUS_ERR = 0x8001
	,STATUS_ABORT = 0x8002
	,STATUS_UNSUPPORT_CMD = 0x8003
	,STATUS_PROTOCOL_ERR = 0x8004
	,STATUS_BUFFER_OVERFLOW = 0x8005
	,STATUS_SECURITY_DENY = 0x8006
	,STATUS_CHECKSUM_ERR = 0x8007
	,STATUS_THREAD = 0x8008
	,STATUS_USB_SCAN_ERR = 0x8009
	,STATUS_INVALID_SESSION = 0x800A
	,STATUS_INVALID_STAGE = 0x800B
	,STATUS_NOT_IMPLEMENTED = 0x800C
	
	//device err
	,STATUS_UNSUPPORT_OP = 0x9000
	,STATUS_READ_DATA_FAIL = 0x9001
	,STATUS_WRITE_DATA_FAIL = 0x9002
	,STATUS_DATA_FAIL = 0x9003
	,STATUS_USB_FAIL = 0x9004
	,STATUS_TOO_LARGE = 0x9005
	,STATUS_SPARSE_INCOMPLETE = 0x9006
	,STATUS_UNKNOWN_TYPE = 0x9007
	,STATUS_UNSUPPORT_CTRL_CODE = 0x9008
	,STATUS_ERASE_FAIL = 0x9009
	,STATUS_PARTITON_NOT_FOUND = 0x900A
	,STATUS_READ_PT_FAIL = 0x900B
	,STATUS_EXCEED_MAX_PART_NUM = 0x900C
	,STATUS_UNKNOWN_STORAGE_TYPE = 0x900D
	,STATUS_DRAM_TEST_FAILED = 0x900E
	,STATUS_DETECT_DRAM_TEST_FAILED = 0x900F

	//emmc err
	,STATUS_MMC_ERR = 0xA000
	
	//DRAM init error
	
	,STATUS_SETUP_DRAM_FAIL = 0xB000
	,STATUS_SETUP_PLL_ERR = 0xB001
	,STATUS_DRAM_NOT_SUPPORT = 0xB002
	,STATUS_RAM_FLOARTING = 0xB003
	,STATUS_RAM_UNACCESSABLE = 0xB004
	,STATUS_RAM_ERROR = 0xB005
	,STATUS_EMI_SETTING_VERSION_ERROR = 0xB006
	,STATUS_EXT_RAM_ERROR = 0xB007

	//command 
	,STATUS_DEVICE_CTRL_EXCEPTION = 0xC000
	,STATUS_SHUTDOWN_CMD_FAIL = 0xC0001
	,STATUS_DOWNLOAD_FAIL = 0xC002
	,STATUS_UPLOAD_FAIL = 0xC003

	/* security */
	,ROM_INFO_NOT_FOUND = 0xD000
	,CUST_NAME_NOT_FOUND = 0xD001
	,ROM_INFO_DEVICE_NOT_SUPPORTED = 0xD002

	//brom
	,STATUS_BROM_CMD_STARTCMD_FAIL = 0xE000
	,STATUS_BROM_BBCHIP_HW_VER_INCORRECT = 0xE001
	,STATUS_BROM_CMD_SEND_DA_FAIL = 0xE002
	,STATUS_BROM_CMD_JUMP_DA_FAIL = 0xE003
	,STATUS_BROM_CMD_FAIL = 0xE004

	//da
	,STATUS_DA_VERSION_INCORRECT = 0xF000
	,STATUS_UNSUPPORTED_VER_OF_DA = 0xF001
	,STATUS_DA_NOT_FOUND = 0xF002
	,STATUS_DA_HASH_VER_FAIL = 0xF003
	
	//emmc otp
	,STATUS_DA_EMMC_OTP_NOT_SUPPORT = 0x10000
	,STATUS_DA_EMMC_OTP_EXIST = 0x10001
	,STATUS_DA_EMMC_OTP_LOCKED = 0x10002
	,STATUS_DA_EMMC_OTP_LOCK_FAIL = 0x10003
	,STATUS_DA_EMMC_OTP_UNLOCKED = 0x10004
	
	//Note: need modify nand driver with error code "S_..."
	,STATUS_DA_NAND_OTP_NOT_SUPPORT = 0x11000
	,STATUS_DA_NAND_OTP_EXIST = 0x11001
	,STATUS_DA_NAND_OTP_LOCKED = 0x11002
	,STATUS_DA_NAND_OTP_LOCK_FAIL = 0x11003
	,STATUS_DA_NAND_OTP_UNLOCKED = 0x11004
	,STATUS_DA_OTP_READ_FAIL = 0x11005
	,STATUS_DA_OTP_PROGRAM_FAIL = 0x11006
	
	//Lib
	,STATUS_SCATTER_FILE_INVALID = 0x12000
	,STATUS_DA_FILE_INVALID = 0x12001
	,STATUS_INVALID_HSESSION = 0x12002
	,STATUS_DA_SELECTION_ERR = 0x12003
	,STATUS_FILE_NOT_FOUND = 0x12004
	,STATUS_PRELOADER_INVALID = 0x12005
	,STATUS_EMI_HDR_INVALID = 0x12006
	,STATUS_OPEN_FILE_ERR = 0x12007
	,STATUS_WRITE_FILE_ERR = 0x12008
	,STATUS_READ_FILE_ERR = 0x12009
	,STATUS_STORAGE_MISMATCH = 0x1200A
	,STATUS_INVALID_PARAMETER = 0x1200B
	,STATUS_INVALID_GPT = 0x1200C
	,STATUS_INVALID_PMT = 0x1200D
	,STATUS_WRITE_PT_FAILED = 0x1200E
	,STATUS_INSUFFICIENT_BUFFER = 0x1200F
	,STATUS_LAYOUT_CHANGED = 0x12010
	,STATUS_PARSE_XML_ERROR = 0x12011
	,STATUS_NODE_NOT_EXIST = 0x12012
	,STATUS_UNKNOWN_TEST_TYPE = 0x12013

	//sec
	,STATUS_SEC_DL_FORBIDDEN = 0x13000
	,STATUS_SEC_IMG_TOO_LARGE = 0x13001
	,STATUS_SEC_PL_VFY_FAIL = 0x13002
	,STATUS_SEC_IMG_VFY_FAIL = 0x13003
	,STATUS_SEC_HASH_OP_FAIL = 0x13004
	,STATUS_SEC_HASH_BINDING_CHK_FAIL = 0x13005
	,STATUS_SEC_INVALID_BUF = 0x13006
	,STATUS_SEC_BINDING_HASH_NOT_AVAIL	  = 0x13007
	,STATUS_SEC_WRITE_DATA_NOT_ALLOWED	  = 0x13008
	,STATUS_SEC_FORMAT_NOT_ALLOWED		  = 0x13009
	,STATUS_SEC_SV5_PUBK_AUTH_FAIL		  = 0x1300A
	,STATUS_SEC_SV5_HASH_VFY_FAIL		  = 0x1300B
	,STATUS_SEC_SV5_RSA_OP_FAIL 		  = 0x1300C
	,STATUS_SEC_SV5_RSA_VFY_FAIL		  = 0x1300D
	,STATUS_SEC_SV5_GFH_NOT_FOUND		  = 0x1300E
	,STATUS_SEC_NOT_VALID_CERT1 		  = 0x1300F
	,STATUS_SEC_NOT_VALID_CERT2 		  = 0x13010
	,STATUS_SEC_NOT_VALID_IMGHDR		  = 0x13011
	,STATUS_SEC_SIG_SZ_NOT_VALID		  = 0x13012
	,STATUS_SEC_PSS_OP_FAIL 			  = 0x13013
	,STATUS_SEC_CERT_AUTH_FAIL			  = 0x13014
	,STATUS_SEC_PUBK_AUTH_MISMATCH_N_SIZE   = 0x13015
	,STATUS_SEC_PUBK_AUTH_MISMATCH_E_SIZE   = 0x13016
	,STATUS_SEC_PUBK_AUTH_MISMATCH_N	    = 0x13017
	,STATUS_SEC_PUBK_AUTH_MISMATCH_E	    = 0x13018
	,STATUS_SEC_PUBK_AUTH_MISMATCH_HASH     = 0x13019
	,STATUS_SEC_CERT_OBJ_NOT_FOUND		    = 0x1301A
	,STATUS_SEC_CERT_OID_NOT_FOUND		    = 0x1301B
	,STATUS_SEC_CERT_OUT_OF_RANGE		    = 0x1301C
	,STATUS_SEC_OID_NOT_MATCH			    = 0x1301D
	,STATUS_SEC_LEN_NOT_MATCH			    = 0x1301E
	,STATUS_SEC_ASN1_UNKNOWN_OP 		    = 0x1301F
	,STATUS_SEC_OID_IDX_OUT_OF_RANGE	    = 0x13020
	,STATUS_SEC_OID_TOO_LARGE			    = 0x13021
	,STATUS_SEC_PUBK_SZ_MISMATCH		    = 0x13022
	,STATUS_SEC_SWID_MISMATCH			    = 0x13023
	,STATUS_SEC_HASH_SZ_MISMATCH		    = 0x13024
	,STATUS_SEC_IMGHDR_TYPE_MISMATCH	    = 0x13025
	,STATUS_SEC_IMG_TYPE_MISMATCH		    = 0x13026
	,STATUS_SEC_IMGHDR_HASH_VFY_FAIL	    = 0x13027
	,STATUS_SEC_IMG_HASH_VFY_FAIL		    = 0x13028
	,STATUS_SEC_VIOLATE_ANTI_ROLLBACK	    = 0x13029
	,STATUS_SEC_SECCFG_NOT_FOUND		    = 0x1302A
	,STATUS_SEC_SECCFG_MAGIC_INCORRECT	    = 0x1302B
	,STATUS_SEC_SECCFG_NOT_VALID		    = 0x1302C
	,STATUS_SEC_CIPHER_MODE_INVALID 	    = 0x1302D
	,STATUS_SEC_CIPHER_KEY_INVALID		    = 0x1302E
	,STATUS_SEC_CIPHER_DATA_UNALIGNED	    = 0x1302F	
