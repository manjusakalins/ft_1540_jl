...
//------------------------------------------------------------------------------
typedef HANDLE (__stdcall *CbFunc_Com_CreateFile)(const char * pPortName, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_CancelIo)(HANDLE hCon, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_CloseHandle)(HANDLE hCon, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_WriteFile)(HANDLE hCon, const void *pBuf, DWORD nNumberOfBytesToWrite, DWORD *pNumberOfBytesWritten, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_ReadFile)(HANDLE hCon, void *pBuf, DWORD nNumberOfBytesToRead, DWORD *pNumberOfBytesRead, char* filename, const int line);

typedef DWORD (__stdcall *CbFunc_Com_GetLastError)(char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_FlushFileBuffers)(HANDLE hCon, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_ClearCommBreak)(HANDLE hCon, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_ClearCommError)(HANDLE hCon, DWORD *pErrors, COMSTAT *pStat, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_SetupComm)(HANDLE hCon, DWORD dwInQueue, DWORD dwOutQueue, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_EscapeCommFunction)(HANDLE hCon, DWORD dwFunc, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_GetCommProperties)(HANDLE hCon, COMMPROP *pCommProp, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_GetCommState)(HANDLE hCon, DCB *pDCB, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_GetCommTimeouts)(HANDLE hCon, COMMTIMEOUTS *pCommTimeouts, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_PurgeComm)(HANDLE hCon, DWORD dwFlags, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_SetCommState)(HANDLE hCon, DCB *pDCB, char* filename, const int line);
typedef _BOOL (__stdcall *CbFunc_Com_SetCommTimeouts)(HANDLE hCon, COMMTIMEOUTS *pCommTimeouts, char* filename, const int line);
...
LIBEXPORT void __stdcall FlashTool_SetStopFlag();
