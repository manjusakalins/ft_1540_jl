...
std::string EnumToRomString(unsigned int id)
{
    ...
    case EMMC_PART_BOOT1:
        return std::string("EMMC_BOOT_1");

    case EMMC_PART_BOOT2:
        return std::string("EMMC_BOOT_2");

    case EMMC_PART_RPMB:
        return std::string("EMMC_RPMB");

    case EMMC_PART_GP1:
        return std::string("EMMC_GP1");

    case EMMC_PART_GP2:
        return std::string("EMMC_GP2");

    case EMMC_PART_GP3:
        return std::string("EMMC_GP3");

    case EMMC_PART_GP4:
        return std::string("EMMC_GP4");

    case EMMC_PART_USER:
        return std::string("EMMC_USER");

    case EMMC_PART_BOOT1_BOOT2:
        return std::string("EMMC_BOOT1_BOOT2");
    }
